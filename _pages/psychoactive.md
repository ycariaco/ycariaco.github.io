...
.psychoactive-page .axis-figure-center {
  clear: both;
  width: min(100%, 980px);
...
.psychoactive-page .axis-figure-center img {
  width: 100%;
  height: auto;
  display: block;
  border: 0;
...
<div class="psychoactive-page">
  ...
  <figure class="axis-figure-center" aria-label="Placenta–brain axis schematic">
    <img
      ...
      alt="Placenta–brain axis illustration"
      loading="lazy"
      decoding="async">
  </figure>
  ...
  <p>This research aims to provide a more complete understanding of how prenatal opioid and cannabis exposure affects fetal development. By focusing on the placenta–brain axis, we can move beyond describing outcomes and begin identifying mechanisms. Understanding what the placenta communicates to the fetal brain may help reveal early biomarkers of risk, clarify how combined drug exposure alters development, and support future harm-reduction strategies for pregnancies affected by substance exposure.</p>

  <p>Ultimately, this work seeks to generate knowledge that can inform prenatal care, patient counseling, and public health approaches. By connecting placental biology with fetal brain development and later behavior, this project may help explain why some exposed offspring are more vulnerable to neurodevelopmental impairments and identify biological pathways that could be targeted for future intervention.</p>

  <div class="references" id="references">
    <strong>References</strong>
    <ol class="ref-list">
      <li id="ref-1">
        <a href="https://www.cdc.gov/pregnancy/during/polysubstance-use.html" target="_blank" rel="noopener">
          Centers for Disease Control and Prevention. Polysubstance Use During Pregnancy. Updated May 8, 2025.
        </a>
      </li>

      <li id="ref-2">
        <a href="https://www.cdc.gov/opioid-use-during-pregnancy/about/index.html" target="_blank" rel="noopener">
          Centers for Disease Control and Prevention. About Opioid Use During Pregnancy. Updated May 1, 2026.
        </a>
      </li>

      <li id="ref-3">
        <a href="https://doi.org/10.3389/fped.2023.1071889" target="_blank" rel="noopener">
          Balalian AA, Graeve R, Richter M, Fink A, Kielstein H, Martins SS, Philbin MM, Factor-Litvak P. Prenatal exposure to opioids and neurodevelopment in infancy and childhood: a systematic review. <em>Frontiers in Pediatrics</em>. 2023;11:1071889.
        </a>
      </li>
      ...
      <li id="ref-5">
        <a href="https://doi.org/10.1038/s12276-025-01601-2" target="_blank" rel="noopener">
          Lewis E, Lee SJ, Park HR. Placenta-derived extracellular vesicles in fetal health: emerging insights into brain development and environmental interactions. <em>Experimental &amp; Molecular Medicine</em>. 2025;57:2729–2738.
        </a>
      </li>

      <li id="ref-6">
        <a href="https://www.acog.org/clinical/clinical-guidance/clinical-consensus/articles/2025/10/cannabis-use-during-pregnancy-and-lactation" target="_blank" rel="noopener">
          American College of Obstetricians and Gynecologists. Cannabis Use During Pregnancy and Lactation. Clinical Consensus No. 10. October 2025.
        </a>
      </li>
